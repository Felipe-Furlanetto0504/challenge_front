...
export default function Menu() {
  ...
  return (
    <nav className="flex space-x-6 text-white font-medium space-y-4 p-2">
      ...
      <Link to="/remedios" className="hover:text-gray-200 transition">Rémedios</Link>
      ...
      <Link to="/cadastro" className="hover:text-gray-200 transition">Cadastro</Link>
      <Link to="/integrantes" className="hover:text-gray-200 transition">Integrantes</Link>
    </nav>
  );
